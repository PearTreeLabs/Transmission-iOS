...
{
    return [UIColor colorWithRed:0.87 green:0.87 blue:0.87 alpha:1.0];
}

+ (UIColor *) progressBlueColor
{
    return [UIColor colorWithRed:0.35 green:0.67 blue:0.98 alpha:1.0];
}

+ (UIColor *) progressDarkBlueColor
{
    return [UIColor colorWithRed:0.616 green:0.722 blue:0.776 alpha:1.0];
}

+ (UIColor *) progressGreenColor
{
    return [UIColor colorWithRed:0.44 green:0.89 blue:0.40 alpha:1.0];
}

+ (UIColor *) progressLightGreenColor
{
    return [UIColor colorWithRed:0.62 green:0.99 blue:0.58 alpha:1.0];
}

+ (UIColor *) progressDarkGreenColor
{
    return [UIColor colorWithRed:0.627 green:0.714 blue:0.639 alpha:1.0];
}

+ (UIColor *) progressRedColor
{
    return [UIColor colorWithRed:0.902 green:0.439 blue:0.451 alpha:1.0];
}

+ (UIColor *) progressYellowColor
{
    return [UIColor colorWithRed:0.933 green:0.890 blue:0.243 alpha:1.0];
}
